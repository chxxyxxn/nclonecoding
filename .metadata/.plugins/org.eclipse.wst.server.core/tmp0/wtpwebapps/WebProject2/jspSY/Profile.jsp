	...
	%>
		...
		<div class="main-box">
            ...
            <div class="proflie-box" style="height:410px;">
        	 ...
        	 <!-- 팔로워수  -->
			   <div class="contentbox2"><span style="font-weight: 600;"><%=postViewDao.getFollowerCnt(loginID) %></span>&nbsp;follower &nbsp;&nbsp;
                        
              <!-- 팔로잉 수 -->
                    <span style="font-weight: 600;"><%=postViewDao.getFollowingCnt(loginID) %></span>&nbsp;following</div>  
                </div>
            </div>
