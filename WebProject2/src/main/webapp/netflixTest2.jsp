    ...
    <div class="window">
            ...
            <div class="drama-detail">
                ...
                <div class="detail-information-overlay">
                    ...
                    <div class="movie-explanation-container">
                        ...
                        %>
                            <div class="round-bundle" movieDramaId="<%=dRDto.getMovieDramaId() %>">
                                <div style="height:75px; margin-top: 26px;">
                                    <div class="drama-round">
                                ...
                                <div>
                                	<a href="<%=dRDto.getFullVideo() %>">
                                    	<img style="position:absolute;" class="round-image" src="<%=dRDto.getEpisodeImage() %>">
                                    	<div class="round-hover-play-button">
        ...
        <div class="main-fifth">
            <div class="main-all-contents3">
                ...
                <%
                	ArrayList<VideoIdDto> dPI = vIDao.dramaPosterImage();
        ...
        <div class="main-sixth">
            <div class="main-all-contents3">
                ...
                <%
                	ArrayList<VideoIdDto> vI = vIDao.moviePosterImage();
                    ...
                    <div class="tab">
                        ...
                        <div id="account-menu" style="width: 60px; cursor: pointer;">
                            <div class="account-menu-item"><a class="login-profile">
                                    <img class="login-profile-image"
                                        src="https://occ-0-3077-988.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABZltMGrbjUxXYnK36RwsKIJBJe06r4p87oJlLWdBvTsZhvHzaYeB6ZivJh5i2iki_gK1e8nX5CDIGF6OsvPrGHvnrzkYOe0.png?r=b97"></a>
                            </div>
