...
public class CommentDAO {
	...
	//댓글작성
	public int addComment(int postID, String comments) {   // 1:성공, 0:실패
		Connection conn = DBConnection.getConnection();
		String sql = "insert into comments(comment_id, post_id, writer, write_date, comments, like_cnt)  values (seq_comments.nextval,?,1,sysdate,?,0)";
		int result = 0;
		try {
